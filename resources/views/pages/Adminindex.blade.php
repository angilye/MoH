    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <ul class="nav flex-column nav-pills">
                ...
                <li class="nav-item dropdown">
                    <ul class="nav flex-column collapse in " id="userMenu">
                            ...
                            <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">Action <span class="badge badge-info">4</span></a>
                            <div class="dropdown-divider"></div>
            ...
            <ul class="nav flex-column nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-list" aria-hidden="true"></i> Layouts &amp; Templates</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-book" aria-hidden="true"></i> Pages</a></li>
            </ul>
        ...
        <div class="col-sm-9">
            ...
            <ul class="list-inline pull-right">
                <li class="nav-item"><a href="#"><i class="fa fa-cog" aria-hidden="true"></i></a></li>
