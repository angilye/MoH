...
@section('gestion')
    <div class="offset-sm-2 col-sm-8">
		...
		<div class="panel panel-primary">	
			<div class="panel-heading"><b>Modification d'Update :</b></div>
			<br>
			<div class="panel-body"> 
				<div class="col-sm-12">
					{!! Form::model($update, ['route' => ['updates.update', $update->id], 'method' => 'put', 'class' => 'form-horizontal panel']) !!}
						...
						<div class="form-group">
							...
							<textarea name="contend" class="form-control" id="contend" rows="10">{!! $update->contend !!}</textarea>
