@extends('templateWarzone', ['title' => 'Contact' ])
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2 col-sm-10 offset-sm-1">
                ...
                <form action="{{ route('ticketSend_path') }}" method="POST">
                    ...
                    <div class="form-group">
                        <button class="btn btn-danger btn-block" type="submit">Submit Enquiry &raquo;</button>
                    </div>
                </form>
            </div>
        </div>
